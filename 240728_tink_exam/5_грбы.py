...
Лес можно представить в виде клетчатой таблицы размера ﻿n×3n×3﻿. Свою дорогу лесник начинает в любой из трех клеток первой строки. После чего каждый раз он может переместиться на следующую строку в соседнюю по углу или стороне клетку, если такая существуют и там не кусты кусачие. Более формально, находясь в клетке ﻿(i,j)(i,j)﻿ он может переместиться в одну из трех доступных для прохода клеток ﻿(i+1,j−1)(i+1,j−1)﻿, ﻿(i+1,j)(i+1,j)﻿ и ﻿(i+1,j+1)(i+1,j+1)﻿, если они существуют и там нет кустов.
...
В первой строке задано число ﻿nn﻿ — количество строк в лесу ﻿(1≤n≤104)(1≤n≤104)﻿. В следующих ﻿nn﻿ строках дано по три символа, характеризующих данную строку. Каждый символ равен «﻿..﻿», если в клетке только трава зеленая, «﻿CC﻿», если в этой клетке растут грибочки белые, и «﻿WW﻿», если кусты кусачие. Если в первой строке во всех клетках находятся кусты, прогулка лесника заканчивается, не успев начаться.

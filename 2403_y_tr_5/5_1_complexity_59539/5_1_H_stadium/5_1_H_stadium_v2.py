...
def get_equal_distance(l,x1,v1,x2,v2):
    ...
    if v1*v2 == 0: #случай когда обе скорости равны 0 уже проверили
        ...
        t_list = []
        if v1 != v2:
            t_list.append((-x1 + x2) / (v1 - v2))
            t_list.append((-x1 - x2) / (v1 - v2))
            t_list.append((-x1 + x2 - l) / (v1 - v2))
            t_list.append((-x1 + x2 + l) / (v1 - v2))

        if v1 != -v2:
            t_list.append((-x1 - x2) / (v1 + v2))
            t_list.append((-x1 - x2 + l) / (v1 + v2))
            t_list.append((-x1 - x2 + 2 * l) / (v1 + v2))
            t_list.append((-x1 - x2 + l) / (v1 + v2))
...
#assert get_equal_distance(72036282, 55132452, -373561948, 11464466, -887525183) == ('YES', 0.0528091330)
assert get_equal_distance(72036282, 55132452, -373561948, 11464466, -887525183)[1]-0.0528091330 < 1e-9
